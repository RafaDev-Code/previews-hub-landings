...
structure_key: "landing.helados.figma"
paired_design: "./DESIGN.md"
case_slug: "helados"
case_label: "Helados"
template_slug: "template-02-figma"
variant_slug: "figma"
variant_label: "Figma"
...
- Variante visual: Figma.
- Lente de variante: sistema modular, color flexible, sabores/componentes y exploracion clara.
...
- Composicion de variante: hero modular con categoria, CTA y elementos de producto organizados.
...
- Variante: cards como componentes repetibles: sabor, precio, tag, accion.
...
- Variante: grilla modular y colorida con jerarquia consistente.
...
- Lente: sistema modular, color flexible, sabores/componentes y exploracion clara.
- Sesgo de layout: componentes consistentes, tags, filtros y modularidad fuerte.
- Tono de CTA: claro, util, creativo sin perder sistema.
