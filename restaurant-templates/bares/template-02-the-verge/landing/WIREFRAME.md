...
structure_key: "landing.bares.the-verge"
paired_design: "./DESIGN.md"
case_slug: "bares"
case_label: "Bares"
template_slug: "template-02-the-verge"
variant_slug: "the-verge"
variant_label: "The Verge"
...
# Wireframe Base - Bares / The Verge
...
- Variante visual: The Verge.
- Lente de variante: grafica editorial intensa, cultura, agenda, titulares fuertes y alto contraste.
...
- Composicion de variante: hero como tapa editorial con headline de evento/local y CTA fuerte.
...
- Variante: destacados como notas/cards editoriales: trago, evento, menu, cultura.
...
- Variante: collage grafico con fotos, texto corto y modulos de alto contraste.
...
- Lente: grafica editorial intensa, cultura, agenda, titulares fuertes y alto contraste.
- Sesgo de layout: ritmo editorial, titulares grandes, bloques asimetricos y agenda visible.
- Tono de CTA: cultural, urgente, con personalidad.
