...
structure_key: "landing.comida-delivery.starbucks"
paired_design: "./DESIGN.md"
case_slug: "comida-delivery"
case_label: "Comida delivery"
template_slug: "template-03-starbucks"
variant_slug: "starbucks"
variant_label: "Starbucks"
...
# Wireframe Base - Comida delivery / Starbucks
...
- Variante visual: Starbucks.
- Lente de variante: habito diario, menu por categorias, pickup, cercania y ritual repetible.
...
- Composicion de variante: hero calido con bebida/producto de temporada y accion de menu o pickup.
...
- Variante: productos por ocasion: favoritos, temporada, combos y frecuentes.
...
- Variante: producto, barra, take away, ritual y momentos cotidianos.
...
- Lente: habito diario, menu por categorias, pickup, cercania y ritual repetible.
- Sesgo de layout: categorias claras, promos suaves, disponibilidad y local cercano.
- Tono de CTA: cotidiano, amable, recurrente.
