...
structure_key: "landing.comida-internacional.airbnb"
paired_design: "./DESIGN.md"
case_slug: "comida-internacional"
case_label: "Comida internacional"
template_slug: "template-01-airbnb"
variant_slug: "airbnb"
variant_label: "Airbnb"
...
# Wireframe Base - Comida internacional / Airbnb
...
- Variante visual: Airbnb.
- Lente de variante: experiencia calida, confianza, fotografia grande, prueba social y reserva sin friccion.
...
- Composicion de variante: hero editorial con imagen amplia, ubicacion visible, rating y CTA de reserva.
...
- Variante: cards generosas con foto, nombre, detalle humano y precio claro.
...
- Variante: grid respirado de experiencia: salon, mesa, comida y barrio.
...
- Lente: experiencia calida, confianza, fotografia grande, prueba social y reserva sin friccion.
- Sesgo de layout: espacio generoso, componentes redondeados, informacion de confianza arriba del fold.
- Tono de CTA: humano, cercano, orientado a planificar la visita.
